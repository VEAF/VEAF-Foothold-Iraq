...
upgrades = {
	...
	hidden2Group = {
		blue = {},
		red = {'Hiddengroup2-Fixed1', 'Hiddengroup2-Fixed2', 'Hiddengroup2-Fixed3', 'Hiddengroup2-Fixed4', 'Hiddengroup2-Fixed5', 'Hiddengroup2-Fixed12',
		...
		'Hiddengroup2-Fixed13'}
	},
	OutPostMission = {
		blue = {},
		red = {'OutPost-Mission-Fixed-1','OutPost-Mission-Fixed-2','OutPost-Mission-Fixed-3'}
	},
	ChamankiMission = {
		blue = {},
		red = {'Chamanki-Mission-Fixed-1','Red SAM SHORAD AAA Chamanki-Mission-Fixed-2','Chamanki-Mission-Fixed-3'}
	},
	KoyaMission = {
		blue = {},
	...
	DukanMission = {
		...
		red = {'Dukan-Mission-Fixed-1','Dukan-Mission-Fixed-2','Dukan-Mission-Fixed-3', 'Dukan-Mission-Fixed-4', 'Dukan-Mission-Fixed-5', 'Dukan-Mission-Fixed-6', 
			'Red SAM AAA Fixed Dukhan-Mission Fixed-7'}
	},
	BarzanMission = {
		blue = {},
	...
	hidden3Group = {
		blue = {},
		red = { 'Hiddengroup3-Fixed5', 'Hiddengroup3-Fixed6', 'Hiddengroup3-Fixed3', 'Hiddengroup3-Fixed7'}
	},
	EWRMantisNetwork = {
		blue = {},
	...
	ChemSiteMission = {
		blue = {},
		red = {'Fixed-redArmor2-1', 'Fixed-redInfantry2-manpad', 'Armour Group Chemsite Fixed','chemsite1', 'chemsite2', 'chemsite3', 'chemsite4', 'chemsite5', 'chemsite6',
		'chemsite7', 'chemsite8'}
	},
	DuhukCityGroup = {
		blue = {'blueInfantry'},
	...
	SahraDefence = {
		blue = {},
		red = {'Red SAM SHORAD SA-15', 'Red SAM SA-11','Red SAM AAA 3 Sahra Fixed','Red SAM AAA 4 Sahra Fixed'}
    },
	BaladDefence = {
		blue = {},
	...
	hidden5Group = {
	    blue = {},
		red = {'Hiddengroup5-Fixed-1', 'Hiddengroup5-Fixed-2', 'Hiddengroup5-Fixed7', 'Hiddengroup5-Fixed8'}
	}
}   
...
if Era == 'Vietnam' then
	FootholdSaveBaseName = 'FootHold_IRAQ_v0.1_Vietnam'
elseif Era == 'Coldwar' then
	FootholdSaveBaseName = 'FootHold_IRAQ_v0.1_Gulfwar'
else
	FootholdSaveBaseName = 'FootHold_IRAQ_v0.1'
end
...
local vnSwap = {
	...
	['Red Armor Group6'] = 'Red Armor Group Vietnam 1',
	['Red Armor Group7'] = 'Red Armor Group Vietnam 3',
	['Red Armor Group8'] = 'Red Armor Group Vietnam 2',
	['Red Armor Group9'] = 'Red Armor Group Vietnam 4',
...
RandomUpgradeTemplates = {
	...
	maybesam = { sam = {0,1}, shorad = {1,2}, aaa = {1,2}, ground = 0, armor = 0, arty = 0, total = {2,5}, flakChance = 10, flakSecondChance = 0, flakMax = 1 },
	shorad = { sam = 0, shorad = {2,4}, aaa = 0, ground = 0, armor = 0, arty = 0, total = {2,4}, flakChance = 0, flakSecondChance = 0, flakMax = 1 },
	shoradsmal = { sam = 0, shorad = {1,2}, aaa = 0, ground = 0, armor = 0, arty = 0, total = {1,2}, flakChance = 0, flakSecondChance = 0, flakMax = 1 },
...
bc:addHiddenConnection("Mosul City","Al Tall")
bc:addHiddenConnection("Sulaimaniyah Airport","Erbil Airport")
bc:addHiddenConnection("Sulaimaniyah Airport","InsurgentCamp")
bc:addHiddenConnection("Qayyarah Airfield","Hammam Al Alil")
bc:addHiddenConnection("Qayyarah Airfield","Tal Afar")
bc:addHiddenConnection("Qayyarah Airfield","Erbil Airport")

TheaterInfrastructure = {}
TheaterRegions = {
	{
		id = "erbil_air_network",
		kind = "air_network",
		name = "Erbil Air Network",
		zones = {
			{ name = "Erbil Airport", role = "core" },
			{ name = "Erbil Defence", role = "defence" },
			{ name = "Koya", role = "member" },
			{ name = "Dukan", role = "member" },
			{ name = "Sangasar", role = "member" },
		},
	},
	{
		id = "nineveh_corridor",
		kind = "strategic_corridor",
		name = "Nineveh Corridor",
		zones = {
			{ name = "Mosul City", role = "core" },
			{ name = "Hammam Al Alil", role = "member" },
			{ name = "Tal Afar", role = "member" },
			{ name = "Al Tall", role = "member" },
			{ name = "Qayyarah Airfield", role = "member" },
		},
	},
	{
		id = "kirkuk_sulaimaniyah_network",
		kind = "air_network",
		name = "Kirkuk and Sulaimaniyah",
		zones = {
			{ name = "Al Abbasi", role = "foothold" },
			{ name = "Kirkuk City", role = "core" },
			{ name = "Sulaimaniyah Airport", role = "member" },
			{ name = "Said Sadiq", role = "member" },
			{ name = "Maydan", role = "member" },
			{ name = "Sarqala", role = "member" },
			{ name = "Khormato", role = "member" },
		},
	},
	{
		id = "sahra_air_defence",
		kind = "air_defence",
		name = "Al-Sahra Air Defence",
		zones = {
			{ name = "Al-Sahra Airport", role = "core" },
			{ name = "Sahra Defence", role = "defence" },
		},
	},
	{
		id = "ramadi_air_defence",
		kind = "air_defence",
		name = "Ramadi Air Defence",
		zones = {
			{ name = "Ramadi", role = "core" },
			{ name = "Ramadi SAM", role = "defence" },
		},
	},
	{
		id = "balad_air_defence",
		kind = "air_defence",
		name = "Balad Air Defence",
		zones = {
			{ name = "Balad Airbase", role = "core" },
			{ name = "Balad Defence", role = "defence" },
		},
	},
	{
		id = "baghdad_air_defence",
		kind = "air_defence",
		name = "Baghdad Air Defence",
		zones = {
			{ name = "Al-Salam Airbase", role = "core" },
			{ name = "SAM East", role = "defence" },
			{ name = "SAM West", role = "defence" },
			{ name = "SAM South", role = "defence" },
		},
	},
}
TheaterAreas = {
	{
		id = "kurdistan_foothold",
		kind = "mountain_corridor",
		name = "Kurdistan Foothold",
		regions = { "erbil_air_network" },
		zones = {
			{ name = "Bashur Airport", role = "hub" },
			{ name = "Barzan", role = "gateway" },
			{ name = "Chamanki", role = "approach" },
			{ name = "OutPost", role = "approach" },
			{ name = "Duhok City", role = "gateway" },
		},
	},
	{
		id = "nineveh",
		kind = "strategic_corridor",
		name = "Nineveh",
		regions = { "nineveh_corridor" },
		zones = {
			{ name = "Chemsite", role = "resource" },
			{ name = "MiningFacility", role = "resource" },
		},
	},
	{
		id = "kirkuk_sulaimaniyah",
		kind = "air_network",
		name = "Kirkuk and Sulaimaniyah",
		regions = { "kirkuk_sulaimaniyah_network" },
	},
	{
		id = "sahra_gateway",
		kind = "strategic_corridor",
		name = "Al-Sahra Gateway",
		regions = { "sahra_air_defence" },
		zones = {
			{ name = "FOB Therethar", role = "gateway" },
		},
	},
	{
		id = "western_iraq",
		kind = "strategic_corridor",
		name = "Western Iraq",
		regions = { "ramadi_air_defence" },
		zones = {
			{ name = "Al-Asad Airbase", role = "hub" },
			{ name = "InsurgentCamp", role = "support" },
			{ name = "Fallujah", role = "gateway" },
			{ name = "FOB Samarra", role = "gateway" },
		},
	},
	{
		id = "baghdad",
		kind = "strategic_hinterland",
		name = "Baghdad and Central Iraq",
		regions = {
			"balad_air_defence",
			"baghdad_air_defence",
		},
		zones = {
			{ name = "SecretTechFacility", role = "infrastructure" },
			{ name = "Oil production Site", role = "resource" },
			{ name = "Uranium enrichment Site", role = "infrastructure" },
			{ name = "Scud City", role = "infrastructure" },
		},
	},
}
...
zones.oilsite:registerTrigger('destroyed', function(event, sender)
	bc:addFunds(2,500)
	trigger.action.outTextForCoalition(2,L10N:Get("IRAQ_EVENT_OIL_PRODUCTION_DISABLED"),20)
end, 'disableoilsite')

zones.uranium:registerTrigger('destroyed', function(event, sender)
	bc:addFunds(2,500)
	trigger.action.outTextForCoalition(2,L10N:Get("IRAQ_EVENT_URANIUM_ENRICHMENT_DISABLED"),20)
end, 'disableuranium')

zones.scudcity:registerTrigger('destroyed', function(event, sender)
	bc:addFunds(2,500)
	trigger.action.outTextForCoalition(2,L10N:Get("IRAQ_EVENT_SCUD_CITY_DESTROYED"),20)
end, 'disablescudcity')
...
StrategicBomber.Configure({
	...
	[2] = {
		...
		recoveryMinRunwayLengthMeters = 2195,
...
evc = EventCommander:new({ decissionFrequency=30*60, decissionVariance=30*60, skipChance = 15, strikeFrequency=5*60})
...
evc:addEvent({
	...
	action = function()
		...
		local setBluePlayers = SET_CLIENT:New():FilterCategories({ "plane", "helicopter" }):FilterCoalitions("blue"):FilterActive(true):FilterStart()
		local convoyZone = ZONE:New("ConvoyZone")
		convoyZone:Trigger(setBluePlayers)

		function convoyZone:OnAfterEnteredZone(From, Event, To, Client)
			if not Client or not Client:IsAlive() then return end
			trigger.action.setUserFlag("ConvoyMove", 1)
		end
	end,
	canExecute = function()
...
mc:trackMission({
	...
	endAction = function()
		...
		bc:cancelGroupTargetMission('FindHimInKanaqin')
	end,
...
mc:trackMission({
    ...
    endAction = function()
		bc:cancelGroupTargetMission('StrikeTarget3')
		if isRedTemplateEnabled("SA-6") then
...
evc:addEvent({
	...
	action = function()
		...
		local setBluePlayers = SET_CLIENT:New():FilterCategories({ "plane", "helicopter" }):FilterCoalitions("blue"):FilterActive(true):FilterStart()
		local convoyZone = ZONE:New("ConvoyZone2")
		convoyZone:Trigger(setBluePlayers)

		function convoyZone:OnAfterEnteredZone(From, Event, To, Client)
			if not Client or not Client:IsAlive() then return end
			trigger.action.setUserFlag("ConvoyMove2", 1)
		end
	end,
	canExecute = function()
...
mc:trackMission({
    ...
    endAction = function()
		...
		bc:cancelGroupTargetMission('Artillery2')
    end,
	isActive = function()
...
mc:trackMission({
    ...
    endAction = function()
		...
		bc:cancelGroupTargetMission('helohunt')
    end,
    isActive = function()
