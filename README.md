...
The output is `VEAF_Foothold_Iraq_ICAO_ORBI_<date>.miz`.

> **The file name matters.** `_ICAO_ORBI` is read by the RealWeather extension of DCSServerBot,
> which fetches Baghdad's live METAR at mission start. Renaming the mission without that
